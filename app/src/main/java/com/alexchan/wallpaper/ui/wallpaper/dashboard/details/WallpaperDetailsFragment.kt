...
class WallpaperDetailsFragment : Fragment() {
    override fun onCreateView(
        ...
        val userPhotoCollection =
            WallpaperDetailsFragmentArgs.fromBundle(requireArguments()).selectedPhoto
        val viewModelFactory = WallpaperDetailsViewModelFactory(userPhotoCollection, application)
        val wallpaperDetailsViewModel =
            ViewModelProvider(this, viewModelFactory).get(WallpaperDetailsViewModel::class.java)
